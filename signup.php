...
<body><ul class="sidenav">
 <li><div style=""><img src="images/logom.png" height=45px width=80px>
<ul class="right">
  <li><a href="login.php"><p id="rcorners1"><h>Login</h></p></a></li></div>
  </ul> 
</ul></h1></p></a></li>
<?php
...
if($conn->query($sql) === TRUE)
{echo "reported";
?><a href="index.php"><br><h1> home</h1></a><?php
}
else
{echo "error".$conn->error;}
$conn->close();
